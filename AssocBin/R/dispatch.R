...
##' @details `inDep` is a wrapper function which organizes and
...
summary.inDep <- function(object, ..., adjustP=FALSE) {
    dat <- object$data
...
##' @describeIn methods Print method for `inDep`
print.inDep <- function(object, ...) {
    nprs <- length(object$pairs)
